	...
	for(var j = 0; j< dates.length; j++){
		...
		for (var i = j*4; i < (j*4)+4; i++) {
	      ...
	      // $('.thumbnail-list').html(list);
	        ...
	        var list = "<div class = 'thumbnail'><div class = 'thumbnail-image' data-toggle='modal' data-target='videoModal'><img src="+data[i].thumbnail_path+" class='col-md-12 image'" +
	        		"name="+data[i].video_path+">"+
	        		"<div class='middle'><span class='glyphicon glyphicon-play-circle'></span></div>"
